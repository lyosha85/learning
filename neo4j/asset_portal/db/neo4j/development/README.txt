...
Welcome to Neo4j release 2.2.3, a high-performance graph database.
...
For full instructions, see http://neo4j.com/docs/2.2.3/deployment.html
...
* Getting Started: http://neo4j.com/docs/2.2.3/introduction.html
* The Neo4j Manual: http://neo4j.com/docs/2.2.3/
